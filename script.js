...
for (var i=0;i<9;i++){
    count=9*i;
    document.getElementsByClassName("box")[i].innerHTML="<div class='cell'><input type='text' id='"+(count+1)+"' class='input cell-input'></div><div class='cell'><input type='text' id='"+(count+2)+"' class='input1'></div><div class='cell'><input type='text' id='"+(count+3)+"' class='input1'></div><div class='cell'><input type='text' id='"+(count+4)+"' class='input1'></div><div class='cell'><input type='text' id='"+(count+5)+"' class='input1'></div><div class='cell'><input type='text' id='"+(count+6)+"' class='input1'></div><div class='cell'><input type='text' id='"+(count+7)+"' class='input1'></div><div class='cell'><input type='text' id='"+(count+8)+"' class='input1'></div><div class='cell'><input type='text' id='"+(count+9)+"' class='input1'></div>"
}
